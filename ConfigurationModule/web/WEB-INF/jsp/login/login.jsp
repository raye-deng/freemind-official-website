...
<div style="text-align: center;">
    <div class="divimg">
        <form action="${pageContext.request.contextPath}/login/loading.cfg">
            <div style=" left:600px;top:200px;">
                <p>
                    <i style="margin-right: 5px;font-size: 20px;color: #3faeeb;" class="icon-user"></i>
                    <input style=" margin-top:60px;background-color:#ffffff ;border: 1px solid; height: 25px;width:160px;color:#213f71;" id="id" type="text"  maxlength=20/>
                </p>
                <p>
                    <i style="margin-right: 5px;font-size: 20px;color: #3faeeb;" class="icon-key"></i>
                    <input style=" margin-top:15px;background-color:#ffffff ;border: 1px solid; height: 25px;width:160px;color:#213f71;" id="userPassword" type="password"  maxlength=20/>
                </p>
                <p>
